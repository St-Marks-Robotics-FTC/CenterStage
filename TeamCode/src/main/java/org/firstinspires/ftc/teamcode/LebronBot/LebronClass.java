...
public class LebronClass {
    ...
    public TouchSensor actuatorLimit;
    ...
    //level 3 = highest level 2 = lower level 1 = level 1 level 0 = transfer
    public static int actuatorUp3 = 1000;
    public static int actuatorDown = 0;
    public static int actuatorIncrement = 100;
...
//        right = hardwareMap.get(TouchSensor.class, "rightSensor");
    ...
    public void retractSlides() {
        setSlides(slidesDown, actuatorDown);
    }

    public void slidesToLevel(int level) {
        setSlides(level1 +  (level - 1) * levelIncrement, actuatorDown+(level-1)*actuatorIncrement);
    }

    public void manualSlides(double power) {
        setSlides(getSlidePos() + (int) (power * 50), getActuatorPosition());
    }
    ...
    public void setSlides(int pos, int actuatorPos) {
