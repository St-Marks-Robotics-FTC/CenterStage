...
public class RedCloseTrussSTATE extends  LinearOpMode{
    ...
    public void runOpMode() throws InterruptedException {
        ...
        TrajectorySequence left = robot.drive.trajectorySequenceBuilder(startPose) // left
                // Drive to spike
                .setReversed(true)
                .splineToSplineHeading(new Pose2d(14, -4, Math.toRadians(-30)), Math.toRadians(135))
                .build();
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                ...
                .transitionTimed(2.7, RedCloseSTATE.LinearStates.RETRACT)
                ...
                .transitionTimed(1)
                .state(RedFarSTATE.LinearStates.SUCKY)
                .onEnter(() -> {
                    intakeNum--;
                ...
                .onEnter(() -> {
                    ...
                    robot.drive.followTrajectorySequenceAsync(robot.drive.trajectorySequenceBuilder(robot.drive.getPoseEstimate())
                            ...
                            .splineToConstantHeading(new Vector2d(-36, -60), Math.toRadians(-35))
                            .build());
                    intakeNum--;
                })
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                ...
                .onEnter(()-> {
                    ...
                    robot.drive.followTrajectorySequenceAsync(robot.drive.trajectorySequenceBuilder(robot.drive.getPoseEstimate())
                            ...
                            .splineToConstantHeading(new Vector2d(42, -39), Math.toRadians(45))
                            .build());
//                    robot.drive.followTrajectorySequenceAsync(robot.drive.trajectorySequenceBuilder(robot.drive.getPoseEstimate())
//                            .setReversed(true)
//                            .setTangent(Math.toRadians(30))
...
//                            .build());
                ...
                .transition(() -> backstage, LinearStates.BACKSTAGE)
                .transitionTimed(2)
                ...
                .onEnter(() -> {
                    camRead=false;
                    robot.drive.followTrajectorySequenceAsync(robot.drive.trajectorySequenceBuilder(robot.drive.getPoseEstimate())
                            .lineToLinearHeading(new Pose2d(50, placementY, Math.toRadians(180)))
                            .build());
                })
                .onExit(() -> {
                    robot.outtake.openLeft();
                ...
                .onEnter(() -> {
                    ...
                    robot.drive.followTrajectorySequence(robot.drive.trajectorySequenceBuilder(robot.drive.getPoseEstimate())
                            .splineToConstantHeading(new Vector2d(20, -60), Math.toRadians(-135))
                            .build());
                    robot.drive.followTrajectorySequence(robot.drive.trajectorySequenceBuilder(robot.drive.getPoseEstimate())
                            .splineToConstantHeading(new Vector2d(-36, -58), Math.toRadians(180))
                            .build());
                    robot.drive.followTrajectorySequence(robot.drive.trajectorySequenceBuilder(robot.drive.getPoseEstimate())
                            .splineToConstantHeading(new Vector2d(-45, -36), Math.toRadians(145))
                            .build());
//                    robot.drive.followTrajectorySequence(robot.drive.trajectorySequenceBuilder(robot.drive.getPoseEstimate())
...
//                            .build());
                ...
                .transitionTimed(5, LinearStates.DISTANCERELOCALIZE)
                .state(LinearStates.BACKSTAGE)
                .onEnter(() -> {
                    camRead=false;
                    placementY=50;
                    robot.drive.followTrajectorySequenceAsync(robot.drive.trajectorySequenceBuilder(robot.drive.getPoseEstimate())
                ...
                .transitionTimed(0.6, LinearStates.RETRACT)
                // Fail safe
