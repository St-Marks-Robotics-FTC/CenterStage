...
//        robot.drive.setPoseEstimate(new Pose2d(-50,-30,Math.toRadians(180)));
        robot.drive.setPoseEstimate(new Pose2d(-60,-36,Math.toRadians(180)));
        waitForStart();
...
//        RobotMovement.goTO(robot.drive, new Pose2d(-30, -20, Math.toRadians(-60)), 0.7, 0.75);
        path1.add(new CurvePoint(-60,-36,Math.toRadians(180), 1, 1, 25,0,0));
        path1.add(new CurvePoint(-60,-12,Math.toRadians(180), 1, 1, 25,0,0));
        path1.add(new CurvePoint(42,-12,Math.toRadians(180), 1, 1, 25,0,0));
        path1.add(new CurvePoint(42,-36,Math.toRadians(180), 1, 1, 25,0,0));

//        path1.add(new CurvePoint(40,0,Math.toRadians(-60), 1, 1, 20,0,0));
//        path1.add(new CurvePoint(40,-90,Math.toRadians(-90), 1, 1, 20,0,0));
//        path1.add(new CurvePoint(-6,-94,Math.toRadians(-180), 1, 1, 20,0,0));
//        path1.add(new CurvePoint(-6,-72,Math.toRadians(90), 1, 1, 20,0,0));
//        path1.add(new CurvePoint(100,0,Math.toRadians(0), 1, 1, 20,0,0));

        ArrayList<CurvePoint> path2 = new ArrayList<>();
        path2.add(new CurvePoint(42,-36,Math.toRadians(180), 1, 1, 25,0,0));
        path2.add(new CurvePoint(42,-12,Math.toRadians(180), 1, 1, 25,0,0));
        path2.add(new CurvePoint(-60,-12,Math.toRadians(180), 1, 1, 25,0,0));
        path2.add(new CurvePoint(-60,-36,Math.toRadians(180), 1, 1, 25,0,0));
