...
//        robot.drive.setPoseEstimate(new Pose2d(-40,-40,Math.toRadians(90)));
        robot.drive.setPoseEstimate(new Pose2d(-50,-30,Math.toRadians(-90)));
...
//        path1.add(new CurvePoint(40, 0, Math.toRadians(90), 0.75, 0.5, 25, 0, 0));
        path1.add(new CurvePoint(-50,-30,Math.toRadians(-90), 1, 1, 20,0,0));
        path1.add(new CurvePoint(-50,0,Math.toRadians(-90), 1, 1, 20,0,0));
...
//        RobotMovement.goTO(robot.drive, new Pose2d(-30, -20, Math.toRadians(-60)), 0.7, 0.75);
        ...
        path2.add(new CurvePoint(50,0,Math.toRadians(180), 1, 1, 20,0,0));
        path2.add(new CurvePoint(-50,0,Math.toRadians(180), 1, 1, 20,0,0));
        path2.add(new CurvePoint(-50,-30,Math.toRadians(-90), 1, 1, 20,0,0));
