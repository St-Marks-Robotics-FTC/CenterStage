...
public class TwoWheelLocalizer extends TwoTrackingWheelLocalizer implements Localizer {
    ...
    private Motor.Encoder perpindicularPod;
    private Motor.Encoder parallelPod;
    ...
    public TwoWheelLocalizer(HardwareMap hardwareMap) {
        ...
        this.horizontalPosition = () -> parallelPod.getPosition();
        this.lateralPosition = () -> perpindicularPod.getPosition();
        this.imuAngle = () -> (imu.getAngularOrientation().firstAngle);;
