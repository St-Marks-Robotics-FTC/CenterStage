...
@Config
@Autonomous
public class bluePurple extends LinearOpMode {
...
//        drive.setPoseEstimate(new Pose2d(12, -60, Math.toRadians(90)));
        ...
        TrajectorySequence left = drive.trajectorySequenceBuilder(startPose)
                .splineToSplineHeading(new Pose2d(-40, 18, Math.toRadians(-50)), Math.toRadians(-90))
        ...
        TrajectorySequence right = drive.trajectorySequenceBuilder(startPose)
                ...
                .splineToSplineHeading(new Pose2d(-46, 32, Math.toRadians(-180)), Math.toRadians(-90))
                .UNSTABLE_addTemporalMarkerOffset(0, ()->{
                    robot.setArm(-830);
                })
                .waitSeconds(2)
                .splineToSplineHeading(new Pose2d(-38.5, 32, Math.toRadians(-180)), Math.toRadians(0))
                .UNSTABLE_addTemporalMarkerOffset(0, ()->{
                    robot.openClaw();
                })
                .UNSTABLE_addTemporalMarkerOffset(0, ()->{
